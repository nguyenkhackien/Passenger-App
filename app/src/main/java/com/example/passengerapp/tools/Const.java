package com.example.passengerapp.tools;

public class Const {
    public static final int costPerKmMotor = 6000;
    public static final int costPerKmCar = 12000;
    public static final String car = "car";
    public static final String motor = "motorbike";
